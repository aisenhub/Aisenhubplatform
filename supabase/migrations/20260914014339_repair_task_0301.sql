-- RC-03 / TASK-0301
-- Provider observations are untrusted facts.  Keep the observation durable,
-- but make the grant decision explicitly fail closed when any contract field
-- is absent, malformed, or does not match the immutable checkout mapping.
