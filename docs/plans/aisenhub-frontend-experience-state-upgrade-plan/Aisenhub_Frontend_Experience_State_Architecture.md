...
> FE-R1：本文件为前端架构唯一维护正文；2026-09-09按main@b563a98校准。旧SHA为研究历史，不是实施起点。Auth已实施，中文优先为本期要求。具体合同见 [FE-R1执行合同](frontend-experience-state-upgrade/references/fe-r1-execution-contracts.md) 与 [中文UI合同](frontend-experience-state-upgrade/references/chinese-ui-contract.md)。
