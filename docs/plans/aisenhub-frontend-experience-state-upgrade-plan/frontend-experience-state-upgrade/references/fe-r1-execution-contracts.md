...
修订日期：2026-09-10；当前代码基线：`main@54ff797`（文档维护提交另行记录）。以下是 FE-R1 执行合同与能力边界；Phase 01～08 与 FE-D02 已有本地代码批次和验证记录，但合同级剩余项仍未全部关闭。与旧研究快照描述冲突时，本修订用于执行；公共安全/业务合同仍以上层架构和专题为准。
