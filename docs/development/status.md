...
| FE-V 状态/故障矩阵 | PARTIAL | FE-V08 已补 Local API/SQL 边界与浏览器 `replayed_existing` UI 分支，Consumer 敏感 mutation 已补网络 unknown/显式状态检查，Admin 已补 429/503/409 主文案与技术详情隔离矩阵；仍需迟到响应、409/412/429/503/202 全矩阵、正向高风险 mutation 及 Files/Settings 全状态行为证据。已有 T12/T16 Local PASS 不替代完整故障注入。 |
