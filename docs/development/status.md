...
| M4～M6 | M4-02～M4-07 PASS（Local）；M4-08及后续文件体验未实现 | 执行M4-08；M5/M6按路线 |
...
- 当前下一项：执行 M4-08，基于 M4-07 的文件状态与下载边界实现最小 Admin/Consumer 页面；T17-R1、M4-01、M5-01仍有独立范围，T18-S继续等待托管输入。
