...
| M4～M6 | M4-02～M4-05 PASS（Local）；M4-06及后续文件体验未实现 | 执行M4-06；M5/M6按路线 |
...
- 当前下一项：执行 M4-06，基于 M4-05 的删除/结算边界实现 Replace 原子切换与竞争恢复；T17-R1、M4-01、M5-01仍有独立范围，T18-S继续等待托管输入。
