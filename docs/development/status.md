...
| M4～M6 | M4-02、M4-03 PASS（Local）；HTTP/Storage/worker仍未实现 | M4-04及后续M4任务；M5/M6按路线 |
...
- 当前下一项：执行 M4-04，基于 M4-03 状态机实现有界 HTTP 上传与可信 Storage adapter；T17-R1、M4-01、M5-01仍有独立范围，T18-S继续等待托管输入。
