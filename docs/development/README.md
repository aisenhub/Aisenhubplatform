...
历史 ASU-R1 与 FE-R1 执行计划包已从当前仓库清理。ASU-01～05、ASU-V01～16、Phase 01–08 和 FE-D02 的历史范围与验证不再通过失效链接维护；当前 Auth、安全和前端边界以 `docs/architecture.md`、`docs/auth-security.md`、当前代码和本目录仍保留的合同文件为准。历史证据不自动授权后续任务。
