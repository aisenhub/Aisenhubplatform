...
> 状态：In Progress。BILL-01～BILL-07 的本地实现/验证已完成，包含升级兼容 fixture 与独立止损开关演练；真实 Provider、G-OPS 与生产门槛仍未运行。
...
| BILL-07 | 完整验收/迁移恢复/发布准备 | BILL-02～06；真实购买就绪还需 G-PROVIDER/G-OPS | 本地最终检查、升级兼容 fixture、独立止损开关演练已完成；真实调度/G-PROVIDER/G-OPS 未运行 |
